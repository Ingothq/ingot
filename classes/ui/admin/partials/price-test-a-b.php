...
<div class="ingot-config-group">
	<label for="<?php echo esc_attr( $a_id ); ?>" class="a-label">
		<?php _e( 'Price Variation For A', 'ingot' ); ?>
	</label>
...
<div class="ingot-config-group">
	...
	<input id="<?php echo esc_attr( $b_id ); ?>" class="number-field test-b" type="number" value="<?php echo esc_attr( $test[ $index ][ 'b' ] ); ?>" min="-0.99" max="0.99" required />
</div><!--/b-->
