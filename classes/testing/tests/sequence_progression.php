<?php
/**
 * Functions to handle the flow of sequence progression
 *
 * @package   ingot
...
class sequence_progression {

	/**
	 * Create initial sequence for group
	 *
	 * @since 0.0.6
	 * @since 0.0.9 in this location
	 *
	 ...
	 * @param int $last_winner_id ID of the winning test
	 * @param array $group Group config
	 *
	 * @return bool|\ingot\testing\crud\ID|\WP_Error
	 */
